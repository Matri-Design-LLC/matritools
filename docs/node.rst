...
.. toctree::
   ...
   set_rotate_vec <node-set_rotate_vec>
   set_scale <node-set_scale>
   set_u_scale <node-set_u_scale>
   set_translate <node-set_translate>
   set_tag_offset <node-set_tag_offset>
   set_rotate <node-set_rotate>
   set_rotate_rate <node-set_rotate_rate>
   set_scale_rate <node-set_scale_rate>
   set_translate_rate <node-set_translate_rate>
   set_translate_vec <node-set_translate_vec>
   ...
   set_proximity_mode <node-set_proximity_mode>
   set_segments <node-set_segments>